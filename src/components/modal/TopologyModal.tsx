...
export function TopologyModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-sm animate-in fade-in duration-150 select-none">
      <div
        className="relative w-full max-w-3xl rounded-2xl border border-slate-800 bg-slate-950 shadow-2xl flex flex-col max-h-[88vh] overflow-hidden"
      ...
      >
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-sm font-semibold text-slate-100 flex items-center gap-2">
                ...
                <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-blue-500/10 border border-blue-500/25 text-blue-400">
                  DAG Verified
                </span>
              </h3>
        ...
        <div className="px-5 py-3 bg-slate-900/40 border-b border-slate-800/80 flex items-center justify-between flex-wrap gap-2 text-xs">
          <div className="flex items-center gap-2">
            ...
            {topology.executionOrder.length > 0 ? (
                ...
                {topology.executionOrder.map((nodeId, idx) => {
                  ...
                  return (
                    <React.Fragment key={nodeId}>
                      <span className="px-2 py-0.5 rounded bg-slate-800 border border-slate-700 text-slate-200 text-[11px]">
              ...
              <span className="text-slate-500 italic">暂无节点</span>
            )}
          </div>
        ...
        <div className="flex-1 overflow-auto p-4 bg-[#080c14] font-mono text-xs select-text">
        ...
        <div className="flex items-center justify-between px-5 py-3.5 border-t border-slate-800 bg-slate-900/60">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-slate-800 bg-slate-900 text-xs font-medium text-slate-300 hover:text-slate-100 hover:bg-slate-800 transition-colors"
            >
